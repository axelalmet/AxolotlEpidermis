#ifndef TESTTOPDOWNEPIDERMISFORSERVER_HPP_
#define TESTTOPDOWNEPIDERMISFOREVER_HPP_
...
public:
    void TestWounding()
    {
        ...
        out_ss << index << "/SteadyState";
        std::string ss_output_directory = M_OUTPUT_DIRECTORY + out_ss.str();
        ...
        std::vector<double> drag_constants = {0.5, 0.75, 1.0};
...
#endif /* TESTTOPDOWNEPIDERMISFORSERVER_HPP_ */
